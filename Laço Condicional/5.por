...
programa
{
	...
	funcao inicio()
	{
		...
		se (indice == 0.3){
			escreva("Indústrias do 1° grupo deverão suspender suas atividades.")
		} 
		senao se (indice == 0.4) {
			escreva("Indústrias do 1° e 2° grupo deverão suspender suas atividades.") 
		}
		senao se (indice == 0.5) {
			escreva("Todas as indústrias deverão paralisar suas atividades.")		
		}
